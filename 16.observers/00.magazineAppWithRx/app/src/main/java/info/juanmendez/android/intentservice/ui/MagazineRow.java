 ...
 *
 * <p>While trying to use MVP, I can tell it's not obligatory when the view has a short logic which
 * can simply stay like in this case.
 */
public class MagazineRow extends LinearLayout implements View.OnClickListener {
  ...
  public void onClick(View v) {
    ...
    } else if (magazine.getStatus().equals(MagazineStatus.DOWNLOADED)
        || magazine.getStatus().equals(MagazineStatus.READ)) {
